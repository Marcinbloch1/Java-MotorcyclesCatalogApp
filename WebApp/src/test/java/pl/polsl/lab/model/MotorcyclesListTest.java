...
class MotorcyclesListTest {
     ...
     */
    @BeforeEach
    public void setUp() throws MyException, Exception {
    ...
    /**
     * Getting searched motorcycles but with null
     * Should thrown exception
     */
    @Test
    public void getSearchedMotorcycledListNullCategory() {
        try{
            motorcyclesList.getSearchedMotorcycledList(null, "Sport");
            fail("An exceptions should be thrown due to null category");
        } catch (MyException e) {
            e.printStackTrace();
        }
    }
